...
<div class="card shadow">
  <div class="card-header border-0">
    <div class="row align-items-center">
      ...
      <div class="col text-right">
        <a href="{{ url('patients') }}" class="btn btn-sm btn-default">Cancelar y volver
        </a>
      </div>
    </div>
  </div>
  <div class="card-body">
    ...
    <div class="form-group">
      <label for="description">Descripción(sintomas)</label>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
          <label for="lastname">Médico</label>
      ...
      <div id="hours">
        ...
        @else
          <div class="alert alert-info" role="alert">
           Selecciona un médico(a) y una fecha, para ver sus horas disponibles.
          </div>
        @endif
      </div>
    </div>
